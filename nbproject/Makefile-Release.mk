...
${OBJECTDIR}/anuncio.o: anuncio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/anuncio.o anuncio.cpp

${OBJECTDIR}/anuncioContratado.o: anuncioContratado.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/anuncioContratado.o anuncioContratado.cpp
...
${OBJECTDIR}/listaAnuncio.o: listaAnuncio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaAnuncio.o listaAnuncio.cpp

${OBJECTDIR}/listaAnuncioContratado.o: listaAnuncioContratado.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaAnuncioContratado.o listaAnuncioContratado.cpp

${OBJECTDIR}/listaCanal.o: listaCanal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaCanal.o listaCanal.cpp
...
${OBJECTDIR}/nodoAnuncio.o: nodoAnuncio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoAnuncio.o nodoAnuncio.cpp

${OBJECTDIR}/nodoAnuncioContratado.o: nodoAnuncioContratado.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoAnuncioContratado.o nodoAnuncioContratado.cpp

${OBJECTDIR}/nodoCanal.o: nodoCanal.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoCanal.o nodoCanal.cpp
