...
${OBJECTDIR}/listaEnt.o: listaEnt.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaEnt.o listaEnt.cpp
...
${OBJECTDIR}/nodoEntero.o: nodoEntero.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoEntero.o nodoEntero.cpp

${OBJECTDIR}/pilaEnt.o: pilaEnt.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pilaEnt.o pilaEnt.cpp
